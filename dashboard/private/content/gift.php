<?php
  if (!checkPerm($readAdmin, 'MANAGE_GIFTS')) {
                        ...
                        <tr>
                          ...
                          <td class="productGiftProduct">
                            <?php if ($readProductGifts["giftType"] == 1): ?>
                              ...
                              ?>
                            <?php else: ?>
                              <?php echo $readProductGifts["gift"]; ?> <?php echo $readSettings["creditText"] ?>
                            <?php endif; ?>
                          </td>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select id="selectGiftType" class="form-control" name="giftType" data-toggle="select" data-minimum-results-for-search="-1">
                      ...
                      <option value="2"><?php echo $readSettings["creditText"] ?></option>
                    </select>
                  </div>
                </div>
                <div id="productBlock">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10 offset-sm-2">
                      <div class="input-group input-group-merge">
                        <input type="number" id="inputCredit" class="form-control form-control-prepended" name="gift" placeholder="Hediye verilecek <?php echo $readSettings["creditText"] ?> miktarını yazınız." disabled>
                ...
                <form action="" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select id="selectGiftType" class="form-control" name="giftType" data-toggle="select" data-minimum-results-for-search="-1">
                        ...
                        <option value="2" <?php echo ($readProductGift["giftType"] == 2) ? 'selected="selected"' : null; ?>><?php echo $readSettings["creditText"] ?></option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div id="creditBlock" style="<?php echo ($readProductGift["giftType"] == 2) ? "display: block;" : "display: none;"; ?>">
                    <div class="form-group row">
                      <div class="col-sm-10 offset-sm-2">
                        <div class="input-group input-group-merge">
                          <input type="number" id="inputCredit" class="form-control form-control-prepended" name="gift" placeholder="Hediye verilecek <?php echo $readSettings["creditText"] ?> miktarını yazınız." value="<?php echo ($readProductGift["giftType"] == 2) ? $readProductGift["gift"] : null; ?>" <?php echo ($readProductGift["giftType"] != 2) ? 'disabled' : null; ?>>
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <span class="fa fa-coins"></span>
                            </div>
