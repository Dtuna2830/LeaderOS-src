...
--
-- Tablo için tablo yapısı `HelpArticles`
--
...
--
-- Tablo için tablo yapısı `HelpTopics`
--
...
--
-- Tablo için tablo yapısı `BazaarItems`
--
...
--
-- Tablo için tablo yapısı `BazaarHistory`
--
...
CREATE TABLE IF NOT EXISTS `Settings` (
  ...
  `creditText` VARCHAR(255) NOT NULL DEFAULT 'Kredi',
  `gamingNightText` VARCHAR(255) NOT NULL DEFAULT 'Gaming Gecesi',
  `bonusCredit` INT(3) UNSIGNED NOT NULL DEFAULT '0',
  `bonusCreditMinAmount` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `creditPackageStatus` ENUM('0', '1') NOT NULL DEFAULT '0',
  ...
  `bazaarStatus` ENUM('0','1') NOT NULL DEFAULT '1',
  `forumStatus` ENUM('0','1') NOT NULL DEFAULT '1',
  ...
  `webhookApplicationTitle` VARCHAR(255) NOT NULL DEFAULT 'Yetkili Başvuru',
...
--
-- Tablo için tablo yapısı `AccountPermissions`
--
...
--
-- Tablo için tablo yapısı `AccountRoles`
--
...
--
-- Tablo için tablo yapısı `ShoppingCarts`
--
...
--
-- Tablo için tablo yapısı `ShoppingCartProducts`
--
...
--
-- Tablo için tablo yapısı `OrderProducts`
--
...
--
-- Tablo için tablo yapısı `SeoPages`
--
