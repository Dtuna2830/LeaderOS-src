<?php
  ...
  if (get("action") == "get") {
    ...
    $extraResourcesJS->addResource('/apps/main/public/assets/js/bazaar.js');
  }
?>
            ...
            <div class="col-md-3">
              <div class="img-card-wrapper">
                <div class="img-container">
                  <a class="img-card" href="/pazar/<?php echo $readServers["slug"]; ?>">
                  ...
                  <div class="img-card-bottom">
                    <h5 class="mb-0">
                      <a class="text-white" href="/pazar/<?php echo $readServers["slug"]; ?>">
                ...
                <ul class="list-group list-group-flush">
                  <?php foreach ($servers as $readServers): ?>
                    <li class="list-group-item <?php echo ($readServers["slug"] == get("server")) ? "active":null; ?>">
                      <a href="/pazar/<?php echo $readServers["slug"]; ?>">
                        <?php echo $readServers["name"]; ?>
                      </a>
                    </li>
                  <?php endforeach; ?>
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-auto">
                    <a href="/pazar-yardim" class="text-white">Nasıl Satış Yapılır?</a>
                  </div>
                </div>
              </div>
              <div class="card-body">
                    ...
                    <?php foreach ($products as $readProducts): ?>
                      <div class="col-md-3">
                        <div class="store-card">
                          <img class="store-card-img lazyload" data-src="/apps/main/public/assets/img/items/<?php echo strtolower($readProducts["itemID"]).'.png'; ?>" src="/apps/main/public/assets/img/loaders/store.png" alt="<?php echo $serverName." Ürün - ".$readProducts["name"]." Satın Al"; ?>">
