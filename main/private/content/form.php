    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <?php if (get("action") == 'view' && isset($_GET["form"])): ?>
          ...
          <?php if ($customForm->rowCount() > 0): ?>
            ...
            if (isset($_POST["apply"])) {
              if (!$csrf->validate('apply')) {
                ...
                echo alertSuccess("Form başarıyla yanıtlandı! Yönlendiriliyorsunuz...");
                echo goDelay("/form/detay/$formID", 2);
              }
            }
            ?>
            <div class="card">
          ...
          <?php else: ?>
            <?php echo alertError("Form bulunamadı!") ?>
          <?php endif; ?>
          ...
          <?php if ($form->rowCount() > 0): ?>
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col">
                    <?php echo limitedContent($readForm["title"], 50); ?>
                  </div>
                </div>
              </div>
